...
def main():
    ...
    # 功能 4：关于
        ...
        **v2.1.1 新增优化**：
        ...
        - **标准模式** - 简单模板，适合快速生成
        - **AI 增强模式** - 智能生成，适合专业需求
        - **v2.1.1 优化版** - 智能输入解析 + 缓存加速 + 深色模式 + 更多样式
        """)
    ...
    st.markdown(
        ...
        <div style='text-align: center'>
            <p>🎬 即梦提示词工具 v2.1.1（AI 增强版）| Made with ❤️ using Streamlit</p>
            <p>集成分镜生成器 + 提示词生成器 + 智能模板库</p>
            <p><small>🚀 已优化：智能输入解析、缓存机制、深色模式、15+ 视觉风格</small></p>
        </div>
        """,
